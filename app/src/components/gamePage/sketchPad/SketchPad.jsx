...
import { Ellipse, Line, Pencil, Rectangle, TOOL_ELLIPSE, TOOL_LINE, TOOL_PENCIL, TOOL_RECTANGLE } from './tools';
...
export default class SketchPad extends Component {
  ...
  componentWillReceiveProps({ tool, items, clearAll, width, height }) {
    items
